...
class MatplotlibWidgetRydSeries(QGraphicsView):
    ...
    def addTrace(self):
        filePath = 'C:\\Users\\tpsadmin\\Desktop\\Documents\\Data Mike'
        datapath = QFileDialog.getOpenFileName(self, 'Select WL Scan File', filePath, '(*.txt)')
    ...
    def plotRydSeries(self, laseroffset):
        ...
        rydEn = (2.*10**7)/(rh*(0.25 - (1./nRange**2))) + laseroffset
